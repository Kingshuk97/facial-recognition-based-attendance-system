...
class main:
    ...
    def login(self):
        ...
        if result:
            ...
            #self.head['pady'] = 150
            root.destroy()
            os.system('python3 firstpage1.py')
        else:
    ...
    def cr(self):
        ...
        self.n_password.set('')
        self.logf.pack_forget()
        self.head['text'] = 'ADMIN SIGNUP PAGE'
        self.crf.pack()
    ...
    #Draw Widgets
    def widgets(self):
        self.head = Label(self.master,text = 'ADMIN LOGIN PAGE',font = ('times new roman',35),padx=5,pady = 10,bg="maroon",fg="white")
        self.head.pack()
        ...
        Button(self.logf,text = ' Create Account ',bd = 3 ,font = ('times new roman',20),padx=5,pady=5,command=self.cr,bg="#0D47A1",fg="white").grid(row=9,columnspan=5,sticky=N+E+W+S,padx=5,pady=5)
        Button(self.logf,text = ' Back ',bd = 3 ,font = ('times new roman',20),padx=5,pady=5,bg="maroon",fg="white",command=self.close_window).grid(row=11,columnspan=5,sticky=N+E+W+S,padx=5,pady=5)
        ...
        Button(self.crf,text = ' Back ',bd = 3 ,font = ('times new roman',20),padx=5,pady=5,bg="maroon",fg="white",command=self.close_window).grid(row=13,columnspan=5,sticky=N+E+W+S,padx=5,pady=5)
...
root.configure(background="white") 
#Button(root,text = ' Back ',bd = 3 ,font = ('times new roman',20),padx=5,pady=5,bg="maroon",fg="white").grid(row=13,columnspan=5,sticky=N+E+W+S,padx=5,pady=5)
main(root)
root.mainloop()
