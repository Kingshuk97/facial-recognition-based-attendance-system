...
def function1():
    ...
    os.system("xdg-open synopsis.docx")
...
Button(root,text="Presentation",font=("times new roman",30),bg="#3F51B5",fg='white').grid(row=5,columnspan=2,sticky=N+E+W+S,padx=5,pady=5)
